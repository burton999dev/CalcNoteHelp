...
- Você pode escolher um plano mensal ou anual.
...
- Você pode gerenciar ou cancelar sua assinatura a qualquer momento nas configurações da sua conta do Google Play.
- Recursos e preços estão sujeitos a alterações.
- Consulte nossos Termos de Uso e Política de Privacidade para mais detalhes.
