### Gli annunci scompaiono del tutto
Tutte le pubblicità nell’app vengono nascoste, per un’esperienza d’uso più piacevole.

- L’annuncio a schermo intero all’avvio (una volta ogni 6 ore) viene rimosso, così puoi iniziare a calcolare subito.
- Spariscono i banner nella parte alta delle schermate, lasciando più spazio ai contenuti.
- Anche gli annunci nativi nel menù laterale e nelle impostazioni vengono nascosti, così raggiungi le funzioni desiderate più velocemente.
<br>

### Gestisci liberamente la cronologia dei file
...
- Recuperi facilmente anche i file eliminati per errore.
<br>

### Disponibile il Widget fluttuante
...
### Crea infinite liste definite dall'utente
