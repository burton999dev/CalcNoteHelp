...
### 1. 广告将完全消失
应用内的所有广告都会被隐藏，带来更顺畅的使用体验。

- 启动时每 6 小时出现一次的全屏广告被移除，打开后即可立即开始计算。
- 各界面顶部的横幅广告消失，可更充分利用显示空间。
- 侧边菜单和设置页面中的原生广告也会隐藏，访问所需功能更顺畅。
...
- 每次保存都会自动记录到历史。（**免费方案也会保存历史，因此升级 Pro 后可立即访问过去的记录。**）
- 在文件管理器中可查看历史列表，并恢复到任意保存点。
- 误删的文件也能轻松找回。

### 3. 可使用浮动小部件
让你在保持其他应用打开的同时进行计算与笔记的便捷小部件。
...
- 免费方案仅限 1 个用户定义的列表，Pro 则可无限创建。
- 根据不同用途切换列表，可大幅提升工作效率。
