...
### 1. Minden reklám eltűnik
Az alkalmazás összes hirdetése eltűnik, így kényelmesebb a használat.

- A 6 óránként megjelenő teljes képernyős indítási hirdetés megszűnik, ezért azonnal számolhatsz.
- Az egyes képernyők tetején lévő bannerhirdetések is eltűnnek, több helyet hagyva a tartalomnak.
- Az oldalsó menüben és a beállítások natív hirdetései szintén rejtve maradnak, így gyorsabban eléred a kívánt funkciókat.
...
- A véletlenül törölt fájlok is könnyen visszaállíthatók.
...
- Például böngészőben látott árakat is feljegyezhetsz appváltás nélkül.

### 4. Fájlok rendezése mappákkal
Rendezd áttekinthetően, felhasználási cél szerint a folyamatosan gyarapodó számítási jegyzeteket.
